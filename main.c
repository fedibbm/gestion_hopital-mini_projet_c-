...
int main()
{
    ...
    else
    {
        ...
        while (1)
        {
            ...
            i++;
            if (i >= 100)
            { // Avoid exceeding the array limit
                printf("Le tableau est plein, arrêt de la lecture\n");
                break;
            }
        }
        taille_tab = i; // Update the size of the array
    }
    ...
    while (1)
    {
        ...
        case 1:
        {
            saisir_tab_p(tableau_p, &taille_tab);
            break;
        }
        case 2:
        {
            Ajouter_tab_p(tableau_p, &taille_tab);
            break;
        }
        case 3:
        {
            ...
            scanf("%d", &id);
            rech = recherche_p(tableau_p, taille_tab, id); // rech c'est l'indice de l'�tudiant trouv�
            if (rech == -1)
            {
        ...
        case 5:
        {
            ...
            if (rech != -1)
            {
                ...
                if (strcmp(rep, "oui") == 0)
                {
                    supprimer_p(tableau_p, &taille_tab, rech);
                }
            }
            else
            {
        ...
        case 6:
        {
            affiche_tableau_p(tableau_p, taille_tab);
            break;
        }
        case 0:
        {
